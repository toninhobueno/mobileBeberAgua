...
public class NotificationPublisher extends BroadcastReceiver {
    ...
    /*
        Junho , 24  2021
        @autor antonioaclb00@gmail.com (Antonio Carlos)
         */
    @Override
    ...
    private Notification getNotification(String content, Context context, NotificationManager notificationManager, PendingIntent intent) {
